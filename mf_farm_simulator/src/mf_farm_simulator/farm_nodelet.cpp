...
void FarmNodelet::onInit()
{
  ...
  dynamic_reconfigure::Server<mf_farm_simulator::FarmSimulatorConfig>::CallbackType cb;
...
void FarmNodelet::reconfigure_cb(mf_farm_simulator::FarmSimulatorConfig &config,
  uint32_t level)
{
